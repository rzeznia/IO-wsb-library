...
class HireController extends Controller
{
    ...
    public function index(){
        ...
        return view('contents.hire.index', compact('hires'));
    }
    ...
    public function return($id){
        ...
        if($hire){
            ...
            return redirect()->route('hire.index')->withSuccess('Book returned');
        }else{
            return redirect()->route('hire.index')->withErrors(['Hire not found']);
        }
    }
}