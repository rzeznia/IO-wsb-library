            ...
            <tbody>
                ...
                @foreach($reservations as $reservation)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-outline-success" href="{{ route('admin.reservation.accept', $reservation->id) }}">Accept</a>
                            <a class="btn btn-sm btn-outline-danger " href="{{ route('admin.reservation.reject', $reservation->id) }}">Reject</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
